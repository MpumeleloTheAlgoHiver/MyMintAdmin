...
const tasksHandler = require('./api/_tasks');
...
const giftingHandler = require('./api/_gifting');
...
<body style="font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;line-height:1.6;color:#1e293b;margin:0;padding:0;">
  ...
  // Investor data endpoint — delegates to api/investors/data.js (canonical implementation)
