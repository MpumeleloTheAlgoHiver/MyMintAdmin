-- Hotfix: make reserve-first rebalance settlement safe for enum transaction statuses.
-- Rerunnable. Deploy before retrying a settlement paused at the cash bridge.
